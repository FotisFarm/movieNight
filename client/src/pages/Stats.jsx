...
export default function Stats({ voter }) {
  ...
  useEffect(() => {
    function onKey(e) {
      ...
      // Close whichever modal is open, in order: deepest first
  ...
  }, [modalId, dyTarget, filmList, selectedVoter]);
    ...
    <div className="stats-page">
      ...
      <section className="stats-section">
        ...
        <div className="global-highlights">
          ...
          {bestDecade && (
            <div className="global-highlight" onClick={() => setDyTarget({ type: 'decade', value: bestDecade.dec })}>
